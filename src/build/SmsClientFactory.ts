...
import { SmsCommandableHttpClientV1 } from '../version1/SmsCommandableHttpClientV1';
...
export class SmsClientFactory extends Factory {
	...
	public static HttpClientV1Descriptor = new Descriptor('service-sms', 'client', 'commandable-http', 'default', '1.0');
	...
	constructor() {
		...
		this.registerAsType(SmsClientFactory.HttpClientV1Descriptor, SmsCommandableHttpClientV1);
	}
