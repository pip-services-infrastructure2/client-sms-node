...
const SmsCommandableHttpClientV1_1 = require("../version1/SmsCommandableHttpClientV1");
class SmsClientFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(SmsClientFactory.HttpClientV1Descriptor, SmsCommandableHttpClientV1_1.SmsCommandableHttpClientV1);
    }
}
...
SmsClientFactory.HttpClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-sms', 'client', 'commandable-http', 'default', '1.0');
